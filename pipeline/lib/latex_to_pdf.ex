defmodule LaTeXToPdf do
  ...
  ## Exemplos:
     ...
     iex> LaTeXToPdf.stop()\n
  """
  @spec generate(String.t(), String.t()) :: {:ok, :ok}
  def generate(user, latex) do
    {:ok, GenServer.cast(__MODULE__, {:generate, user, latex})}
  end
  ...
  @impl true
  def handle_cast({:generate, user, latex}, data) do
    ...
    {:noreply, [{user, filename, latex} | data]}
  end
