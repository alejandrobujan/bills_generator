defmodule Filters.LatexFormatter do
  alias Core.StandardLeader
  use StandardLeader

  @impl StandardLeader
  def worker_action({bill, seller, purchaser}),
    do: generate_latex(bill, seller, purchaser)

  @impl StandardLeader
  def next_action(output_data), do: Filters.LatexToPdf.process_filter(output_data)
